...
Thank you for your interest in contributing to Agent Control! We welcome contributions from the community and
...
- **Environment**: Operating system, .NET version, Agent Control version
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/demaconsulting/AgentControl.git
   cd AgentControl
   ```
...
dotnet run --project src/DemaConsulting.AgentControl \
...
Agent Control uses [DemaConsulting.ReqStream][reqstream] for requirements traceability:
...
By contributing to Agent Control, you agree that your contributions will be licensed under the MIT License.

Thank you for contributing to Agent Control!

[code-of-conduct]: https://github.com/demaconsulting/AgentControl/blob/main/CODE_OF_CONDUCT.md
...
[discussions]: https://github.com/demaconsulting/AgentControl/discussions
[issues]: https://github.com/demaconsulting/AgentControl/issues
[security]: https://github.com/demaconsulting/AgentControl/blob/main/SECURITY.md
