...
This document contains the requirements for the Agent Control project.

## Purpose

Agent Control is a reference implementation demonstrating best practices for DEMA Consulting
